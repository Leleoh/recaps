...
#Preview {
    CapsuleCardComponent(capsule: .init(id: UUID(), code: "F5GX3", submissions: [], name: "Academy", createdAt: Date(), offensive: 50, lastSubmissionDate: Date(), validOffensive: false, lives: 3, members: [], ownerId: UUID(), status: CapsuleStatus.inProgress))
}
